...
class asset_management:
    ...
    def __init__(self, root):
        ...
        title=Label(self.root, text="Air India", font=("algerian", 40, "bold"), image=self.icon_title, compound=LEFT, bg="#FB3A3A", fg="white", anchor='w', padx=30).place(x=0, y=0, relwidth=1, height=70)
        ...
        self.clock_label=Label(self.root, text="Welcome to the Air India\t\t  Date:"+cur_date, font=("aileron", 15), bg="#FB3A3A", fg="white")
        ...
        Footer=Label(self.root, text="Nikhil", font=("times new roman", 15), bg="#FB3A3A", fg="white").pack(side=BOTTOM, fill=X)
    ...
    def employee(self):
        ...
        os.system("employee.exe")
    def product(self):

        #self.new_win=Toplevel(self.root)
        #self.new_obj=product_admin_class(self.new_win)
        os.system("product_admin.exe")
